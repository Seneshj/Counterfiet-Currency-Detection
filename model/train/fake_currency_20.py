...
def build_model(): 
    ...
    vgg_model = Model(inputs=input_layer, outputs=[class2, regress2])
    return vgg_model
...
for partition in ['train', 'test', 'val']:
    for image in os.listdir(os.path.join('data', partition, 'images')):
        ...
        if os.path.exists(label_path):
            ...
            coords = list(np.divide(coords, [512, 512, 512, 512]))
